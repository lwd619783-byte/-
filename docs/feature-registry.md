...
| Industry Metric Registry / Provider / Dimensions / Snapshot | Stage 4.2 CLOSED / MERGED / MAIN CI PASS | P1 | Slice 1–6：6 owners / NBS + EIA、reviewed dimensions/snapshot、5 个描述型派生与事实性 Claim Candidates、F2 引用链、Industry F3 与 eligibility abstention gate；DATA/PRODUCTION/PIT/正式景气方法未准入 |
