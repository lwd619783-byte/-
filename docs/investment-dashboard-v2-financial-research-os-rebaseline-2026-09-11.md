...
> 2026-09-24 STRATEGIC CLARIFICATION · **Research Memory ≠ Formal Decision System**。长期知识工作正式冻结为 Drive L0 原件 → ChatGPT 增量研究 → Notion Research Memory；OS 不再扩建完整 Wiki、Notion 镜像、Obsidian 主知识库或普通知识检索。OS 的长期核心是 Structured Fact/Evidence/Verified Claim/Thesis/Investment Expression/Portfolio 与 Provider/PIT/admission/revision/Audit/F1/F2/F3。普通研究发现默认停在 Notion；只有满足正式证据、计算、投资判断或组合影响门槛才晋升 OS。Stage 4.4 已 CLOSED（PR #80，merge/main `68698ae7548aeb46fe9dd95fd0fdfcb4f13d1e4e`，PR/main CI PASS，Production READY）；Stage 4.5 CURRENT，仅建设 Formal Decision System 的 OS Domain MCP。正式工作流见 [投研知识与决策工作流 V1](research-knowledge-decision-workflow-v1.md)。
