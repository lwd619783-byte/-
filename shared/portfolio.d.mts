...
export interface PortfolioInput {
  ...
  accounts: { accountId: string; name: string; receipt: Receipt }[];
...
export interface PortfolioPosition { positionId: string; accountId: string; accountName: string; assetId: string; assetName: string; assetType: string; primaryCategory: string; strategyBucket: string | null; instrumentId: string | null; snapshotId: string; snapshotDate: string; quantity: number; marketValue: number; currency: string; blockers: string[]; lineage: { snapshot: Receipt; account: Receipt; asset: Receipt } }
