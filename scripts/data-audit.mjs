...
// Audited ajv-formats 3.0.1 getTime helper: optional timezone captures 6/7
// are zero for Z. Exact LF-normalized generated bytes AND expression location
// are required; any regenerated/edited module fails closed pending re-review.
const SCHEMA_TIME_HELPER_PINS = {
  "src/services/wikiValidator.generated.mjs": "111ca2a8765e122223879ea296af707431d918dca5da33d5a17d290cef01fd3c",
  "src/services/contributionValidator.generated.mjs": "93508895ddf20188f0aef717e2be4e9939591793dca66aa58e7f72a26fa9fafb",
};
const SAFE_ZERO_RULES = [
  {
    id: "pinned-schema-timezone-capture",
    test: ({ relative, sourceSha256, expression, before }) => SCHEMA_TIME_HELPER_PINS[relative] === sourceSha256
      && /^\|\|0$/.test(expression) && /\+\([A-Za-z_$][\w$]*\[[67]\]$/.test(before),
    reason: "audited generated ajv-formats timezone capture; no business value default",
    scope: "exact-generated-digest-and-timezone-expression",
  },
  {
  ...
  for (const file of files) {
    ...
    lines.forEach((line, index) => {
      ...
      for (const match of matches) {
        ...
        const context = { relative, sourceSha256, line, before: line.slice(0, match.index), after: line.slice(match.index + expression.length), expression };
