...
const output = path.resolve('data-cache/stage-4-5/browser'), harness = path.resolve('data-cache/stage-4-5/browser-harness');
...
const service=createDecisionPublisher(f.runtime,async()=>{throw Error('PORTFOLIO_NOT_CONNECTED');},undefined,()=>new Date(at(12)));
