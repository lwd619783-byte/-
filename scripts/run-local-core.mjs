...
const targets = {
  ...
  'test-local-core': ['--test', 'local-core/tests/database.node.mjs', 'local-core/tests/entities.node.mjs', 'local-core/tests/audit.node.mjs', 'local-core/tests/integration.node.mjs', 'local-core/tests/assets.node.mjs', 'local-core/tests/asset-import.node.mjs', 'local-core/tests/asset-database.node.mjs'],
  'test-assets': ['--test', 'local-core/tests/assets.node.mjs', 'local-core/tests/asset-import.node.mjs', 'local-core/tests/asset-database.node.mjs'],
};
