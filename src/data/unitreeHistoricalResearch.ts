...
// Historical pre-migration research snapshot, retained verbatim from 3edd80f.
// Its original observation/source dates were not recorded; this is not current listing status.
export const unitreeHistoricalResearch: RoboticsPrivateCompany[] = [
  {
    id: "unitree",
    name: "宇树科技",
    market: "未上市",
