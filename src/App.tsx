...
const DecisionSharePanel = lazy(() => import('./components/research/DecisionSharePanel').then(module => ({ default: module.DecisionSharePanel })));
  ...
  return (
    <div className="workspace min-h-screen text-text">
      ...
      />
          ...
          {activeTab === '设置与帮助' && <><WorkspaceSettings openKnowledge={() => navigation.navigateHash('#/knowledge?view=maintenance')} openSources={() => navigatePageId('sources')} /><Suspense fallback={<p>正在载入共享入口…</p>}><DecisionSharePanel dataset={thesisDataset} /></Suspense></>}
