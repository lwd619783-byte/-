...
function unitLabel(snapshot: EarningsExpectationSnapshot) { return snapshot.metric === "eps" ? `${unitDisplayLabel(snapshot.currency)}/股` : ({ yuan: "元", ten_thousand_yuan: "万元", million_yuan: "百万元", hundred_million_yuan: "亿元", currency_per_share: "每股" })[snapshot.unit]; }
