...
export function HomePage({ dataMode, modeLabel, updatedAt, sourceNote, coverageSummary, stats, focusStocks, quoteStocks, activeWatchCount, onNavigate, onOpenStock, now, watchItems=[], tasks=[], events=[], onStartReview, onOpenEvent, timeZone = "Asia/Shanghai", inboxSourceNotice, dataState, dataMessage, expectationSnapshots, industryEvents }: HomePageProps) {
  ...
  return <section className="home-workbench space-y-5" aria-label="首页研究工作台">
    ...
    <details className="ui-v21-overview-tools"><summary>行情、关注公司与研究辅助</summary><p className="mt-3 text-sm text-textMuted">个人观察 {activeWatchCount} 项 · 近 7 日研究事件 {stats.recentEvents} 项 · 预期来源待核验 {stats.pendingExpectationSources} 项</p>
