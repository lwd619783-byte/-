import type { CompanyGuidanceExpectationCorrectionProof, CompanyGuidanceExpectationWarning, EarningsExpectationProviderSnapshot } from "../types";
...
export const COMPANY_GUIDANCE_CORRECTION_PROJECTION_FIELDS: readonly string[];
...
export function validateCompanyGuidanceWorkflowCorrectionProofShape(records: EarningsExpectationProviderSnapshot[], proofs: CompanyGuidanceExpectationCorrectionProof[]): string[];
